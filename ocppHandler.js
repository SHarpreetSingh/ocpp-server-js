...
export class OcppHandler {
    ...
    async handleBootNotification(messageId, payload) {
        ...
        if (!await this.validateBootNotification(bootNotificationSchema, payload)) {
    ...
    async handleStartTransaction(messageId, payload) {
        console.log(`Received StartTransaction from ${this.chargePointId}:`, payload);
    ...
    async handleStopTransaction(messageId, payload) {
        console.log(`Received StopTransaction from ${this.chargePointId}:`, payload);
    ...
    handleCallError(message) {
        const [messageType, messageId, errorCode, errorDescription, errorDetails] = message;
